...
describe('/api/execute-loop/evidence', () => {
  ...
  it('lists evidence runs with safe summary counts', async () => {
    mockReadEvidence.mockReturnValue([
      { id: 'real-1', title: 'Real run', status: 'success', source: 'manual', recordedAt: 'now', steps: {} },
      { id: 'dry-1', title: 'Dry run', status: 'success', source: 'harness-dry-run', recordedAt: 'now', steps: {} },
    ])
