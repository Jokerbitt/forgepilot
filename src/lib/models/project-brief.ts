...
export interface ProjectBrief {
  ...
  /** Free-text implementation direction generated by Brief Studio */
  implementationDirection?: string
  /** List of assumptions generated by Brief Studio */
  assumptions?: string[]
  /** GitHub repository URL created or linked for this project */
