import type { AIProviderConfig, AIModelDef } from './types'
...
const RAW_BUILT_IN_PROVIDER_CONFIGS: AIProviderConfig[] = [
  // ─── Anthropic ─────────────────────────────────────────────────────────────
  {
    id: 'anthropic',
    type: 'anthropic',
  ...
  // ─── Ollama (Local) ────────────────────────────────────────────────────────
  {
    ...
    models: [
      ...
      { id: 'bge-m3',            name: 'BGE M3',              purpose: 'embedding' },
...
export const BUILT_IN_PROVIDER_CONFIGS: AIProviderConfig[] = RAW_BUILT_IN_PROVIDER_CONFIGS.map(config => (
  config.freeTier
    ? {
        ...config,
        freeTier: {
