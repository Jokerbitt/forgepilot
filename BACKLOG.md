...
- [~] M161: Config Backup Routine — tägliches automatisches Backup von `config/*.json` nach `config/backups/YYYY-MM-DD/`; GET /api/backup + POST /api/backup; Vercel Cron 03:00 UTC; 7-Tage-Rotation
